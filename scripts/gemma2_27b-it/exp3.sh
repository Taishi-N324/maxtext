...
export RUN_NAME="gemma2_27b_sft_exp3"
export MODEL_NAME="gemma2-27b"
export CONVERTED_CHECKPOINT="/mnt/filestore/checkpoints_maxtext/gemma2_27b_exp6/checkpoints/50000/50000/items/"
...
python3 -u MaxText/train.py MaxText/configs/base.yml \
    ...
    steps=1496 \
    learning_rate_schedule_steps=1496 \
    learning_rate=2.0e-5 \
    cosine_learning_rate_final_fraction=0.1 \
    warmup_steps_fraction=0.1 \
    checkpoint_period=1495 \
