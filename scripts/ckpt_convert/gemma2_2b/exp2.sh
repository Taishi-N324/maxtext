...
# 変換するチェックポイント番号のリスト
CHECKPOINTS=(5000 7500 10000 12500 15000)

# ベースディレクトリ
BASE_DIR="/mnt/filestore"
CHECKPOINT_DIR="${BASE_DIR}/checkpoints/gemma2_2b_exp2/checkpoints"
OUTPUT_DIR="${BASE_DIR}/checkpoints_hf/gemma2_2b_exp2/checkpoints"
